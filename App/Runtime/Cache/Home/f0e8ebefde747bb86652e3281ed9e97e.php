...
<body>
	...
	<div id="message">
        <ul class="nav nav-pills nav nav-tabs nav-justified">
		 <li role="presentation"><a href="<?php echo U("IndexPage/indexpage");?>">首页</a></li>
		  ...
		  <li role="presentation"   class="active"><a href="<?php echo U("ManageUser/ManageUser");?>">会员管理</a></li>
    	...
    	<div class="panel panel-default">
			  ...
			  <div class="panel-body">
			    	<div class="goods-message">
				        <span class="add-goods">+</span>　会员管理
				        	<ul class="hide-goods">
				            <li><a href="<?php echo U("User/LookUser");?>">查看会员</a></li>
				            <li><a href="<?php echo U("User/DeleteUser");?>">删除会员</a></li>
				            </ul>
        			</div>
			  </div>
		</div>
    ...
    <div id="right">
    	<div class="panel panel-default">
			  <div class="panel-heading">查看歌曲</div>
			  <div class="panel-body">
				  ...
				  <table class="table">
				   ...
				   <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
				   	...
				   	<td><a href="<?php echo U('User/DeleteUser',array('id'=>$vo['id']));?>"><span class="glyphicon glyphicon-remove"></span> </a></td>
